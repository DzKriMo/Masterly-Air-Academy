...
export default function MedicalPage() {
  ...
  return (<div><nav className="sticky top-0 bg-navy-800/95 backdrop-blur border-b border-navy-700 z-30"><div className="max-w-5xl mx-auto px-6 h-16 flex items-center"><h1 className="text-lg font-bold text-white">{t("student.medical", "Medical Certificates")}</h1></div></nav>
