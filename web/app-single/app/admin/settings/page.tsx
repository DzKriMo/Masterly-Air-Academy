...
export default function AdminSettingsPage() {
  ...
  const {
    ...
    queryFn: async () => {
      const d = await api.get<any>(withFullLimit("/system-settings/"));
  ...
  return (
    <div className="min-h-screen bg-navy-900">
      <PageHeader title={t("admin.settings", "System Settings")} backHref="/admin/dashboard" backLabel={t("common.back", "Back to Dashboard")} actions={
          <button
            onClick={() => refetch()}
            disabled={isLoading}
