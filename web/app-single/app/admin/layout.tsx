...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const SECTIONS: NavSection[] = useMemo(() => [
    ...
    {
      id: "training",
      title: t("admin.training", "Training & Exams"),
      Icon: BookOpen,
      items: [
        { href: "/admin/subjects", label: t("admin.subjects", "Subjects"), Icon: BookOpen },
        { href: "/admin/modules", label: t("admin.modules", "Modules"), Icon: BookOpen },
        { href: "/admin/courses", label: t("admin.courses", "Courses"), Icon: BookOpen },
        { href: "/admin/course-enrollments", label: t("admin.courseEnrollments", "Enrollments"), Icon: Users },
        { href: "/admin/attendance", label: t("admin.attendance", "Attendance"), Icon: ClipboardCheck },
        ...
        { href: "/admin/question-bank", label: t("admin.questionBank", "Question Bank"), Icon: HelpCircle },
        { href: "/admin/quizzes", label: t("admin.quizzes", "Quizzes"), Icon: ClipboardList },
        { href: "/admin/exams", label: t("admin.exams", "Exams"), Icon: ClipboardList },
        { href: "/admin/module-lessons", label: t("admin.moduleLessons", "Module Lessons"), Icon: BookOpen },
        { href: "/admin/module-documents", label: t("admin.moduleDocuments", "Module Docs"), Icon: FileText },
        { href: "/admin/module-exercises", label: t("admin.moduleExercises", "Exercises"), Icon: ClipboardList },
        { href: "/admin/ground-evaluations", label: t("admin.groundEvaluations", "Ground Evals"), Icon: ClipboardCheck },
        { href: "/admin/competencies", label: t("admin.competencies", "Competencies"), Icon: Award },
        { href: "/admin/progress-checks", label: t("admin.progressChecks", "Progress Checks"), Icon: ClipboardCheck },
        { href: "/admin/skill-tests", label: t("admin.skillTests", "Skill Tests"), Icon: ClipboardList },
        { href: "/admin/practical-evaluations", label: t("admin.practicalEvaluations", "Practical Evals"), Icon: ClipboardCheck },
        { href: "/admin/quiz-attempts", label: t("admin.quizAttempts", "Quiz Attempts"), Icon: ClipboardList },
      ],
    },
    {
      id: "flight-training",
      title: t("admin.flightTraining", "Flight Training"),
      Icon: Plane,
      items: [
        { href: "/admin/flight-programs", label: t("admin.flightPrograms", "Flight Programs"), Icon: Map },
        { href: "/admin/flight-lesson-templates", label: t("admin.flightLessonTemplates", "Lesson Templates"), Icon: BookOpen },
        { href: "/admin/maintenance-records", label: t("admin.maintenanceRecords", "Maintenance"), Icon: Wrench },
        { href: "/admin/instructor-availability", label: t("admin.instructorAvailability", "Availability"), Icon: Clock },
        { href: "/admin/resource-bookings", label: t("admin.resourceBookings", "Bookings"), Icon: Calendar },
        { href: "/admin/flight-lessons", label: t("admin.flightLessons", "Flight Lessons"), Icon: Plane },
        { href: "/admin/flight-preparations", label: t("admin.flightPreparations", "Preparations"), Icon: ClipboardCheck },
      ],
    },
    {
      id: "quality-safety",
