...
const ALLOWED_PREFIXES: Record<Role, string[]> = {
  ...
  ground_instructor: ["/instructor/dashboard", "/instructor/schedule", "/instructor/courses", "/instructor/modules", "/instructor/students", "/instructor/exams", "/instructor/messages"],
  ...
  chief_ground_instructor: ["/instructor/cgi-dashboard", "/instructor/schedule", "/instructor/courses", "/instructor/modules", "/instructor/students", "/instructor/exams", "/instructor/messages", "/instructor/progression-overview", "/instructor/reports", "/instructor/subject-management"],
};
