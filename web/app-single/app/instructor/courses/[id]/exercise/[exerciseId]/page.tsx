...
export default function InstructorExerciseViewPage() {
  ...
  useEffect(() => {
    ...
    api.get<any>(`/module-exercises/${exerciseId}/`)
      ...
      .catch(err => {
        ...
        setError(t("instructor.exerciseLoadError", "Failed to load exercise."));
      })
      ...
      <PageHeader
        ...
        actions={exercise?.due_date && (
          <span className="text-xs text-yellow-400 bg-yellow-500/10 px-3 py-1 rounded-full">
            {t("instructor.due", "Due")}: {exercise.due_date}
          </span>
        )}
      />
          ...
          <article className="bg-navy-800 border border-navy-700 rounded-2xl p-8 md:p-10">
            ...
            {exercise.instructions ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-500">{t("instructor.noInstructions", "No instructions provided for this exercise yet.")}</p>
              </div>
            )}
          </article>
        )}
