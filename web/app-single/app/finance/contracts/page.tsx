  ...
  const columns: Column<any>[] = [
    ...
    },
    {
      ...
      render: (c) => (<div className="flex gap-1.5" onClick={e => e.stopPropagation()}>
        ...
        {c.file_url && <a href={`/api/contracts/${c.id}/stream/`} target="_blank" className="px-2 py-1 text-xs bg-blue-500/10 border border-blue-500/30 text-blue-400 rounded hover:bg-blue-500/20">View</a>}
      </div>),
    },
  ];
