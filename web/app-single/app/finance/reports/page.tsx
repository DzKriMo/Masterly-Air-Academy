...
export default function FinanceReportsPage() {
  ...
  return (<div className="flex-1 min-w-0">
    <PageHeader title={t('finance.reports', 'Financial Reports')} actions={<ExportButton exports={[{label:t('finance.invoicesExcel', 'Invoices (Excel)'),url:"/export/invoices/",filename:"invoices.xlsx",type:"excel"},{label:t('finance.studentsExcel', 'Students (Excel)'),url:"/export/students/",filename:"students.xlsx",type:"excel"}]}/>} />
    <main className="max-w-7xl mx-auto px-6 py-8">{error && <ErrorCard message={error} onRetry={()=>setError(null)}/>}{isLoading?<LoadingSkeleton type="card" rows={4}/>:<>
